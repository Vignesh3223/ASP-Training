<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Asp_Training.Register" %>
        ...
        <div class="row mb-3 mt-3">
            <div class="col-6">
                ...
                <form id="form1" runat="server" class="mt-4">
                    ...
                    <div class="form-group mb-2">
                        <asp:Label ID="Label6" runat="server" Text="Confirm Password: "></asp:Label><br />
                    ...
                    <asp:Button ID="Button1" class="btn btn-primary mt-2" runat="server" Text="Register" OnClick="btnRegister_Click"/><br />
